// Source: https://codepen.io/TC5550/pen/WNNWoaO
...
void main() {
    ...
    if (sum >= 0.99) {
        ...
        //gl_FragColor = vec4(129.0 / 255.0, 161.0 / 255.0, 192.0 / 255.0, 1.0);
        //gl_FragColor = vec4(mix(vec3(x / WIDTH, y / HEIGHT, 1.0), vec3(0, 0, 0), max(0.0, 1.0 - (sum - 0.99) * 100.0)), 1.0);
        gl_FragColor = vec4(94.0 / 255.0, 129.0 / 255.0, 172.0 / 255.0, 1.0);
        return;
    }

    gl_FragColor = vec4(59.0 / 255.0, 66.0 / 255.0, 82.0 / 255.0, 1.0);
}
